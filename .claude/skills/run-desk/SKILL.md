...
9. **The fold is untouched:** after any change outside the render path, prove the stills did not move — serve a pristine `HEAD` worktree beside the working tree and byte-compare:
   ```bash
