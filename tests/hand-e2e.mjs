...
try {
  ...
  await evalIn(phone, `${HELPERS} act('push to table')`);
  ok(await evalIn(phone, `${HELPERS} until(() => sheetStatus().includes("can't reach the table"), 8000)`, true), 'silence surfaces the dry no-table line (the deck keeps the card, D99)');
