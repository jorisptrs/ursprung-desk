...
export const specimenEvents = [
  { e: 'deposit', night: 0, artifact: {
    ...
    people: ['R.'], provenance: 'curator', visibility: 'public',
  ...
  { e: 'deposit', night: 2, artifact: {
    ...
    caption: 'three stills · the hills', people: ['T.'], provenance: 'curator', visibility: 'public',
  ...
  { e: 'deposit', night: 2, artifact: {
    ...
    caption: '22.5° · flat-foldable', people: ['R.'], provenance: 'curator', visibility: 'public',
    excerpt: { form: 'linework', src: 'assets/placeholder-crease.svg' } } },

  { e: 'deposit', night: 2, artifact: {
    id: 's-012', media: 'note', kind: 'failure', title: 'fugue scoring — no use',
    caption: 'tried twice · stays up', people: ['B.', 'Claude'], provenance: 'curator', visibility: 'public',
  ...
  { e: 'deposit', night: 3, artifact: {
    ...
    people: ['E.'], provenance: 'curator', visibility: 'public',
  ...
  { e: 'deposit', night: 3, artifact: {
    ...
    people: ['Claude'], provenance: 'curator', visibility: 'public',
  ...
  { e: 'deposit', night: 4, artifact: {
    ...
    people: ['M.'], provenance: 'mcp', visibility: 'public',
    excerpt: { form: 'lines' } } },
